...
Evaluate where learners are in their natural development:
...
*Do not assume readiness because of age or credential. Assess actual development.*

### 2. Identify the Experiential Core

Strip the learning objective to its experiential essence:
- What direct encounter would reveal this knowledge?
- How did humanity originally learn this? (Before textbooks existed)
- What problem would make this knowledge necessary?

*Transform "learn X" into "encounter the situation that makes X necessary."*

### 3. Design the Negative Education

Identify what to protect learners FROM:
...
*What should be absent is as important as what is present.*

### 4. Sequence by Natural Necessity

Order learning so each step creates the felt need for the next:
- Concrete → Abstract
- Particular → General
- Problem → Solution
- Question → Answer

*The learner should feel: "I need to know this" before being told.*

### 5. Design for Discovery

Create conditions for learners to discover rather than receive:
