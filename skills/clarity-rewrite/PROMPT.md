...
1. **Brevity** - Use fewer words; cut what doesn't add meaning
2. **Clarity** - Prefer common words to rare ones; prefer concrete to abstract
3. **Rhythm** - Sentences should flow; vary length but default to shorter
