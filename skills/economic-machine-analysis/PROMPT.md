...
**Expansion phase:**
1. Credit is easy, spending increases
2. One person's spending = another's income
3. Higher incomes = more creditworthy = more credit
4. Spending outpaces production = inflation

**Contraction phase:**
1. Central bank raises rates to control inflation
2. Credit becomes expensive, borrowing decreases
3. Spending falls, incomes fall
4. If uncontrolled = recession
5. Central bank lowers rates to stimulate
...
1. Spending is cut dramatically
2. Incomes fall as a result
3. Assets are sold, flooding the market
4. Asset prices collapse
5. Banks get squeezed
6. Credit disappears
7. Social tensions rise

**The Four Levers:**
Policymakers must balance:
1. **Austerity** - Cut spending (deflationary, painful)
2. **Debt defaults/restructuring** - Reduce debt (deflationary, painful)
3. **Wealth redistribution** - Transfer from rich to poor (politically difficult)
4. **Printing money** - Create new money (inflationary)
...
1. Don't have debt rise faster than income (debt will crush you)
2. Don't have income rise faster than productivity (you'll become uncompetitive)
3. Do all you can to raise productivity (that's what matters most long-term)
